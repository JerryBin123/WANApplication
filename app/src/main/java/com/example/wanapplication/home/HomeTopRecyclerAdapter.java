...
public class HomeTopRecyclerAdapter extends RecyclerView.Adapter<HomeTopRecyclerAdapter.myAdapter> {
    ...
    public myAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HomeTopRecyclerAdapter.myAdapter(view);
    }
    ...
    public void onBindViewHolder(@NonNull myAdapter holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (!data.get(holder.getAdapterPosition()).getDesc().equals("")){
