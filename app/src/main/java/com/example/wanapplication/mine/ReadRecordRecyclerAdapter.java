...
public class ReadRecordRecyclerAdapter extends RecyclerView.Adapter<ReadRecordRecyclerAdapter.myAdapter> {
    private List<ReadRecordData> data;
    private Context context;
    private LayoutInflater layoutInflater;

    public ReadRecordRecyclerAdapter(List<ReadRecordData> data, Context context) {
        this.data = data;
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
    }

    public void setData(List<ReadRecordData> data) {
        this.data = data;
